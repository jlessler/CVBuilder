...
THEME_PRESETS: dict[str, dict[str, str]] = {
    ...
    # Harvard FAS — GSAS guide: serif, left-aligned, 0.5–1in margins, 1.0–1.15 line spacing
    "harvard_fas": {
    ...
    # Harvard Medical School — strict HMS format, all-black, bold headings, no decoration
    # Matches Jena (2022) and Hadland (2022) actual HMS CVs
    "harvard_med": {
    ...
    # Stanford Medicine — OAA guide: no mandatory font, clean sans-serif
    "stanford_med": {
    ...
    # MIT — CAPD/CommLab: conservative font, 10–11pt, 0.5–1in margins
    "mit": {
    ...
    # Michigan Engineering — ADAA template: name centered in navy, bold headings, no decoration
    # Matches ADAA CV Template 2023-24
    "michigan_eng": {
    ...
    # Columbia CUIMC — numbered sections, blue bold headings, no decoration
    # Matches CUIMC CV Format guide (2022)
    "columbia_cuimc": {
    ...
    # Imperial College London — navy/blue branding, sans-serif, A4 page
    # Conservative UK academic style, left-aligned
    "imperial": {
    ...
    # University of Oxford — dark Oxford Blue, serif body, A4 page
    # Example CV uses UPPERCASE bold headings with bottom-border
    "oxford": {
    ...
    # University of Hong Kong — HKU Green branding, clean sans-serif, A4 page
    "hku": {
    ...
    # University of Melbourne — Melbourne Blue, serif body, A4 page
    # Guidelines: 12pt font, 2cm margins, black text only, no all-caps
    "melbourne": {
